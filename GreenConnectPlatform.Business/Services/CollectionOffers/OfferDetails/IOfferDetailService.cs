...
public interface IOfferDetailService
{
    ...
    Task<OfferDetailModel> AddOfferDetail(Guid collectorId,Guid collectionOfferId, OfferDetailCreateModel offerDetailCreateModel);
    Task<OfferDetailModel> UpdateOfferDetail(Guid collectorId, Guid offerDetailId,OfferDetailUpdateModel offerDetailUpdateModel);
