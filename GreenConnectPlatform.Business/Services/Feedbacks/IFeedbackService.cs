...
{
    Task<PaginatedResult<FeedbackModel>> GetFeedbacksAsync(int pageNumber, int pageSize, Guid transactionId,
        bool sortByCreatAt);

    Task<PaginatedResult<FeedbackModel>> GetFeedbacksByUserIdAsync(int pageNumber, int pageSize, Guid userId,
        string roleName, bool sortByCreatAt);
