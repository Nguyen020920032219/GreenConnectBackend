    ...
    public partial class InitialDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("RewardItems_pkey", x => x.RewardItemId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("ScrapCategories_pkey", x => x.ScrapCategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("CollectorVerificationInfos_pkey", x => x.UserId);
                    table.ForeignKey(
                        name: "CollectorVerificationInfos_UserId_fkey",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("ScrapPosts_pkey", x => x.ScrapPostId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("UserRewardRedemptions_pkey", x => new { x.UserId, x.RewardItemId, x.RedemptionDate });
                    table.ForeignKey(
                        name: "UserRewardRedemptions_RewardItemId_fkey",
                        column: x => x.RewardItemId,
                        principalTable: "RewardItems",
                        principalColumn: "RewardItemId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "UserRewardRedemptions_UserId_fkey",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("CollectionOffers_pkey", x => x.CollectionOfferId);
                    table.ForeignKey(
                        name: "CollectionOffers_ScrapCollectorId_fkey",
                        column: x => x.ScrapCollectorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "CollectionOffers_ScrapPostId_fkey",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("ScrapPostDetails_pkey", x => new { x.ScrapPostId, x.ScrapCategoryId });
                    table.ForeignKey(
                        name: "ScrapPostDetails_ScrapCategoryId_fkey",
                        column: x => x.ScrapCategoryId,
                        principalTable: "ScrapCategories",
                        principalColumn: "ScrapCategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "ScrapPostDetails_ScrapPostId_fkey",
                        column: x => x.ScrapPostId,
                        principalTable: "ScrapPosts",
                        principalColumn: "ScrapPostId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Transactions_pkey", x => x.TransactionId);
                    table.ForeignKey(
                        name: "Transactions_HouseholdId_fkey",
                        column: x => x.HouseholdId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "Transactions_OfferId_fkey",
                        column: x => x.OfferId,
                        principalTable: "CollectionOffers",
                        principalColumn: "CollectionOfferId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "Transactions_ScrapCollectorId_fkey",
                        column: x => x.ScrapCollectorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("ChatRooms_pkey", x => x.ChatRoomId);
                    table.ForeignKey(
                        name: "ChatRooms_TransactionId_fkey",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Complaints_pkey", x => x.ComplaintId);
                    table.ForeignKey(
                        name: "Complaints_AccusedId_fkey",
                        column: x => x.AccusedId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "Complaints_ComplainantId_fkey",
                        column: x => x.ComplainantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "Complaints_TransactionId_fkey",
                        column: x => x.TransactionId,
                        principalTable: "Transactions",
                        principalColumn: "TransactionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "Feedbacks_RevieweeId_fkey",
                        column: x => x.RevieweeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "Feedbacks_ReviewerId_fkey",
                        column: x => x.ReviewerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("TransactionDetails_pkey", x => new { x.TransactionId, x.ScrapCategoryId });
                    table.ForeignKey(
                        name: "TransactionDetails_ScrapCategoryId_fkey",
                        column: x => x.ScrapCategoryId,
                        principalTable: "ScrapCategories",
                        principalColumn: "ScrapCategoryId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("ChatParticipants_pkey", x => new { x.UserId, x.ChatRoomId });
                    table.ForeignKey(
                        name: "ChatParticipants_ChatRoomId_fkey",
            ...
            migrationBuilder.CreateIndex(
                name: "ChatRooms_TransactionId_key",
                table: "ChatRooms",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_Status_HouseholdId",
                table: "Transactions",
                columns: new[] { "Status", "HouseholdId" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_Status_ScrapCollectorId",
                table: "Transactions",
