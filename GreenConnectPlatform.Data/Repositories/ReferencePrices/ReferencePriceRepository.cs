...
public class ReferencePriceRepository : BaseRepository<GreenConnectDbContext, ReferencePrice, Guid>,
    IReferencePriceRepository
{
    ...
    public async Task<(List<ReferencePrice> Items, int TotalCount)> GetReferencePrices(int pageIndex, int pageSize,
